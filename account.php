          ...
          <ul class="navbar-nav">
            <li class="nav-item dropdown">
              <a class="nav-link text-light bg-primary dropdown-toggle active dropDownAccount" href="#"
                ...
                <img
                  src="https://www.flaticon.com/svg/vstatic/svg/1738/1738691.svg?token=exp=1616471332~hmac=0ee19589a8362d61269904d09fe750ba"
                  alt="profile-img" style="width: 30px; margin-right: 20px">
                Account
              </a>
              <ul class="dropdown-menu bg-primary" aria-labelledby="navbarDropdown">
                ...
                <li><a class="dropdown-item text-light" id="teste-drop" href="#" data-bs-toggle="modal"
                    data-bs-target="#profileModal"><img
                      src="https://www.flaticon.com/svg/vstatic/svg/4312/4312320.svg?token=exp=1616472563~hmac=00fefe9514fea3bfb438a68e0657871d"
                ...
                <li><a class="dropdown-item text-light" href="#" data-bs-toggle="modal"
                    data-bs-target="#myAnnouncesModal"><img
                      src="https://www.flaticon.com/svg/vstatic/svg/3209/3209737.svg?token=exp=1616472618~hmac=15866aac025138f5d36255d514939cbb"
                      alt="profile-img" style="width: 30px; margin-right: 20px">My announces</a></li>

                <li><a class="dropdown-item text-light" href="#" data-bs-toggle="modal"
                    data-bs-target="#referencesModal"><img
                      src="https://www.flaticon.com/svg/vstatic/svg/2885/2885427.svg?token=exp=1616472705~hmac=6a7e7657785989125a57674241ec6c58"
                ...
                <li><a class="dropdown-item text-light" href="logout.php"><img
                      src="https://www.flaticon.com/svg/vstatic/svg/3601/3601881.svg?token=exp=1616472748~hmac=d927e2ae1df4387c2023886df4d3d562"
